...
# 
"""Contains miscelaneous functions used in hmmer_tools scripts.
"""
...
def get_abbrev_fa_record_text_from_obj(obj, db_name, prot_name=None):
    """Takes a Bio.SeqIO sequence object and returns the fasta record as a
    string (two lines for writing to a fasta format file).
    """
    if prot_name is None:
        ...
        prot_name = '_' + prot_name
    text = '>' + obj.description.split(' ', 1)[0] + ' ' + db_name + prot_name + '\n' + obj.seq + '\n'
    return text
