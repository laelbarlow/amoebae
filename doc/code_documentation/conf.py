...
# -*- coding: utf-8 -*-
#
# amoebae documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'amoebae.tex', 'amoebae Documentation',
     'Lael D. Barlow', 'manual'),
]
...
man_pages = [
    (master_doc, 'amoebae', 'amoebae Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'amoebae', 'amoebae Documentation',
     author, 'amoebae', 'One line description of project.',
     'Miscellaneous'),
]
